test_that("doy", {
  ...
  expect_identical(
    dtt_doy(as.Date(c("2004-12-31", "2001-12-31", NA))),
    c(366L, 365L, NA)
  )
})
...
test_that("dayte", {
  ...
  expect_identical(
    dtt_dayte(as.Date(c("2004-02-29", NA, "2001-05-16"))),
    as.Date(c("1972-02-29", NA, "1972-05-16"))
  )
})

test_that("dayte_time", {
  expect_equal(
    dtt_dayte_time(as.POSIXct("2001-05-16 02:03:04")),
